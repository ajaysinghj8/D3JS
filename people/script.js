    ...
    d3.json("network.json", function(error, network) {
        ...
        svg.append("g")
            ...
            .data(network.movies.filter(function(m) {
                return m.links.some(currentNomination) || m.links.some(win);
            }))
            .enter().append("text")
            .attr("transform", function(d) {
            ...
            tooltipDescription
                .html(m.nominations.length ? "\n" + d3.nest()
                    ...
                    .sortKeys(function(a, b) {
                        return d3.ascending(awardRank[a] || 100, awardRank[b] || 100) || d3.ascending(a, b);
                    })
                    .entries(m.nominations)
                    .map(function(n) {
                        return n.key + " - <span class=g-" + awardType[n.key] + ">" + n.values.map(function(n) {
                            return n.person.name;
                        }).join(", ") + "</span>" + (n.values.some(function(n) {
                            return n.won;
                        }) ? "\xa0\u2713" : "");
                    }).join("<br>") : "");
                ...
                case "top":
                    {
                        tooltipPath
                            ...
                            .attr("d", "M0,6" + "a6,6 0 0,1 6,-6" + "H" + (tooltipRect.width - 6) + "a6,6 0 0,1 6,6" + "v" + (tooltipRect.height - 12) + "a6,6 0 0,1 -6,6" + "H" + (tooltipRect.width / 2 + 6) + "l-6,6" + "l-6,-6" + "H6" + "a6,6 0 0,1 -6,-6" + "z");
                ...
                case "bottom":
                    {
                        tooltipPath
                            ...
                            .attr("d", "M0,6" + "a6,6 0 0,1 6,-6" + "H" + (tooltipRect.width / 2 - 6) + "l6,-6" + "l6,6" + "H" + (tooltipRect.width - 6) + "a6,6 0 0,1 6,6" + "v" + (tooltipRect.height - 12) + "a6,6 0 0,1 -6,6" + "H6" + "a6,6 0 0,1 -6,-6" + "z");
        ...
        function movieToPersonLink(d) {
            return "M" + d.movie.x + "," + d.movie.y + "S" + d.x + "," + d.y + " " + d.person.x + "," + d.person.y;
        }

        function personToMovieLink(d) {
            return "M" + d.person.x + "," + d.person.y + "C" + d.x + "," + d.y + " " + d.movie.x + "," + d.movie.y + " " + d.movie.x + "," + d.movie.y;
        }
